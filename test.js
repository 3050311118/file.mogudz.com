  ...
  req.on('end', function() {
    if(req.rawBody !== ""){
       ...
       try{
         ...
         WeixinTemplatePush(json.i,json.c,json.n,json.s,json.t)
         //微信号 报警内容 设备名 序列号
       }catch(e){
...
function WeixinTemplatePush(openid,content,name,sn,type){
    var myDate = new Date();        
   ...
   if(type==="xmj02")
   {
     ...
     templatePush.url="http://wechatinfo.moguzn.com/xmj02map?addr="+arr[0]+"&lng="+arr[1]+"&lat="+arr[2];
   }
